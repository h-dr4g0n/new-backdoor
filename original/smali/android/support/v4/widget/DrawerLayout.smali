...
.field static final j:Landroid/support/v4/widget/q;

.field private static final k:Z


# instance fields
.field private A:Landroid/support/v4/widget/t;
...
.field final c:Landroid/support/v4/widget/bk;

.field final d:Landroid/support/v4/widget/bk;
...
.field private final r:Landroid/support/v4/widget/w;

.field private final s:Landroid/support/v4/widget/w;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/q;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/p;
    ...
    invoke-direct {v2, p0, v3}, Landroid/support/v4/widget/w;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->r:Landroid/support/v4/widget/w;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->s:Landroid/support/v4/widget/w;

    .line 383
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->r:Landroid/support/v4/widget/w;

    invoke-static {p0, v5, v2}, Landroid/support/v4/widget/bk;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/bl;)Landroid/support/v4/widget/bk;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->c:Landroid/support/v4/widget/bk;

    .line 384
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->c:Landroid/support/v4/widget/bk;

    .line 2440
    iput v4, v2, Landroid/support/v4/widget/bk;->k:I

    .line 385
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->c:Landroid/support/v4/widget/bk;

    .line 3404
    iput v1, v2, Landroid/support/v4/widget/bk;->i:F

    .line 386
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->r:Landroid/support/v4/widget/w;

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->c:Landroid/support/v4/widget/bk;

    .line 4068
    iput-object v3, v2, Landroid/support/v4/widget/w;->b:Landroid/support/v4/widget/bk;

    .line 388
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->s:Landroid/support/v4/widget/w;

    invoke-static {p0, v5, v2}, Landroid/support/v4/widget/bk;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/bl;)Landroid/support/v4/widget/bk;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->d:Landroid/support/v4/widget/bk;

    .line 389
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->d:Landroid/support/v4/widget/bk;

    .line 4440
    const/4 v3, 0x2

    iput v3, v2, Landroid/support/v4/widget/bk;->k:I
    ...
    .line 391
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->s:Landroid/support/v4/widget/w;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->d:Landroid/support/v4/widget/bk;

    .line 6068
    iput-object v2, v1, Landroid/support/v4/widget/w;->b:Landroid/support/v4/widget/bk;
    ...
    invoke-direct {v1, p0}, Landroid/support/v4/widget/o;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    invoke-static {p0, v1}, Landroid/support/v4/view/bj;->a(Landroid/view/View;Landroid/support/v4/view/a;)V

    .line 400
    invoke-static {p0}, Landroid/support/v4/view/cf;->a(Landroid/view/ViewGroup;)V
    ...
    .line 402
    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/q;

    invoke-interface {v1, p0}, Landroid/support/v4/widget/q;->a(Landroid/view/View;)V

    .line 403
    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/q;

    invoke-interface {v1, p1}, Landroid/support/v4/widget/q;->a(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method private a(Z)V
    ...
    iget-boolean v6, v0, Landroid/support/v4/widget/u;->c:Z
    ...
    .line 1569
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->c:Landroid/support/v4/widget/bk;
    ...
    .line 1572
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->d:Landroid/support/v4/widget/bk;
    ...
    .line 1579
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->r:Landroid/support/v4/widget/w;

    invoke-virtual {v0}, Landroid/support/v4/widget/w;->a()V

    .line 1580
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->s:Landroid/support/v4/widget/w;
...
.method private static a(Landroid/graphics/drawable/Drawable;I)Z
    ...
    invoke-static {p0}, Landroid/support/v4/b/a/a;->b(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 1174
    :cond_1
    invoke-static {p0, p1}, Landroid/support/v4/b/a/a;->b(Landroid/graphics/drawable/Drawable;I)Z
...
.method static b(Landroid/view/View;)F
    ...
    iget v0, v0, Landroid/support/v4/widget/u;->b:F
...
.method private c()Landroid/view/View;
    ...
    .line 949
    iget v0, v0, Landroid/support/v4/widget/u;->d:I
...
.method public static d(Landroid/view/View;)Z
    ...
    iget v0, v0, Landroid/support/v4/widget/u;->a:I
...
.method public final a(II)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->c:Landroid/support/v4/widget/bk;
    ...
    .line 638
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->d:Landroid/support/v4/widget/bk;
...
.method public final a(Landroid/support/v4/widget/t;)V
    .locals 1
...
.method final a(Landroid/view/View;F)V
    ...
    .line 918
    iget v1, v0, Landroid/support/v4/widget/u;->b:F
    ...
    .line 922
    :cond_1
    iput p2, v0, Landroid/support/v4/widget/u;->b:F
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/view/bj;->c(Landroid/view/View;I)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/view/bj;->a(Landroid/view/View;Landroid/support/v4/view/a;)V
...
.method public computeScroll()V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->d:Landroid/support/v4/widget/bk;

    invoke-virtual {v1}, Landroid/support/v4/widget/bk;->c()Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    .line 7451
    iget v2, v2, Landroid/support/v4/widget/bk;->j:I
    ...
    .line 1405
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->d:Landroid/support/v4/widget/bk;

    .line 8451
    iget v3, v3, Landroid/support/v4/widget/bk;->j:I
...
.method public final e(Landroid/view/View;)V
    ...
    iput v1, v0, Landroid/support/v4/widget/u;->b:F

    .line 1610
    iput v2, v0, Landroid/support/v4/widget/u;->d:I
    ...
    .line 1614
    :cond_1
    iget v1, v0, Landroid/support/v4/widget/u;->d:I

    or-int/lit8 v1, v1, 0x2

    iput v1, v0, Landroid/support/v4/widget/u;->d:I
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/widget/u;-><init>(Landroid/support/v4/widget/u;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 1344
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/q;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->d:Landroid/support/v4/widget/bk;
    ...
    .line 1452
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->c:Landroid/support/v4/widget/bk;

    float-to-int v0, v0

    float-to-int v3, v3

    invoke-virtual {v5, v0, v3}, Landroid/support/v4/widget/bk;->b(II)Landroid/view/View;
    ...
    .line 9327
    iget-object v0, v5, Landroid/support/v4/widget/bk;->d:[F
    ...
    .line 9352
    invoke-virtual {v5, v0}, Landroid/support/v4/widget/bk;->a(I)Z
    ...
    .line 9359
    iget-object v3, v5, Landroid/support/v4/widget/bk;->f:[F

    aget v3, v3, v0

    iget-object v7, v5, Landroid/support/v4/widget/bk;->d:[F
    ...
    .line 9360
    iget-object v7, v5, Landroid/support/v4/widget/bk;->g:[F

    aget v7, v7, v0

    iget-object v8, v5, Landroid/support/v4/widget/bk;->e:[F
    ...
    iget v7, v5, Landroid/support/v4/widget/bk;->b:I

    iget v8, v5, Landroid/support/v4/widget/bk;->b:I
...
.method protected onLayout(ZIIII)V
    ...
    .line 1193
    iget v1, v0, Landroid/support/v4/widget/u;->leftMargin:I

    iget v2, v0, Landroid/support/v4/widget/u;->topMargin:I
    ...
    iget v0, v0, Landroid/support/v4/widget/u;->topMargin:I
    ...
    iget v3, v0, Landroid/support/v4/widget/u;->b:F
    ...
    .line 1212
    :goto_3
    iget v4, v0, Landroid/support/v4/widget/u;->a:I
    ...
    .line 1217
    iget v4, v0, Landroid/support/v4/widget/u;->topMargin:I

    add-int/2addr v9, v2

    iget v11, v0, Landroid/support/v4/widget/u;->topMargin:I
    ...
    iget v2, v0, Landroid/support/v4/widget/u;->b:F
    ...
    .line 1224
    iget v10, v0, Landroid/support/v4/widget/u;->bottomMargin:I
    ...
    iget v11, v0, Landroid/support/v4/widget/u;->bottomMargin:I
    ...
    .line 1237
    iget v12, v0, Landroid/support/v4/widget/u;->topMargin:I
    ...
    iget v13, v0, Landroid/support/v4/widget/u;->bottomMargin:I
    ...
    .line 1240
    iget v4, v0, Landroid/support/v4/widget/u;->bottomMargin:I
...
.method protected onMeasure(II)V
    ...
    .line 1067
    iget v6, v0, Landroid/support/v4/widget/u;->a:I
    ...
    .line 1068
    invoke-static {v10}, Landroid/support/v4/view/bj;->x(Landroid/view/View;)Z
    ...
    .line 1069
    sget-object v11, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/q;

    iget-object v12, p0, Landroid/support/v4/widget/DrawerLayout;->G:Ljava/lang/Object;

    invoke-interface {v11, v10, v12, v6}, Landroid/support/v4/widget/q;->a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    .line 1077
    iget v6, v0, Landroid/support/v4/widget/u;->leftMargin:I

    sub-int v6, v2, v6

    iget v11, v0, Landroid/support/v4/widget/u;->rightMargin:I
    ...
    iget v0, v0, Landroid/support/v4/widget/u;->bottomMargin:I
    ...
    invoke-interface {v11, v0, v12, v6}, Landroid/support/v4/widget/q;->a(Landroid/view/ViewGroup$MarginLayoutParams;Ljava/lang/Object;I)V
    ...
    .line 1084
    invoke-static {v10}, Landroid/support/v4/view/bj;->t(Landroid/view/View;)F
    ...
    invoke-static {v10, v6}, Landroid/support/v4/view/bj;->h(Landroid/view/View;F)V
    ...
    iget v11, v0, Landroid/support/v4/widget/u;->leftMargin:I
    ...
    iget v11, v0, Landroid/support/v4/widget/u;->width:I
    ...
    iget v12, v0, Landroid/support/v4/widget/u;->bottomMargin:I
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .line 1953
    :goto_1
    iget v4, v0, Landroid/support/v4/widget/u;->d:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1505
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->c:Landroid/support/v4/widget/bk;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Landroid/support/v4/widget/bk;->b(II)Landroid/view/View;
...
.method public setDrawerElevation(F)V
    ...
    invoke-static {v1, v2}, Landroid/support/v4/view/bj;->h(Landroid/view/View;F)V
...
.method public setDrawerListener(Landroid/support/v4/widget/t;)V
    ...
    .prologue
    .line 535
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/t;
    ...
    .line 539
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/DrawerLayout;->a(Landroid/support/v4/widget/t;)V

    .line 543
    :cond_1
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/t;
