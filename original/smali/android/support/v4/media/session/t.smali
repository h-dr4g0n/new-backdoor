...
.annotation system Ldalvik/annotation/Signature;
    value = {
        "<T::",
        "Landroid/support/v4/media/session/s;",
        ">",
...
# instance fields
.field protected final a:Landroid/support/v4/media/session/s;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "TT;"
        }
...
.method public final onAudioInfoChanged(Landroid/media/session/MediaController$PlaybackInfo;)V
    ...
    .line 319
    invoke-interface/range {v0 .. v5}, Landroid/support/v4/media/session/s;->a(IIIII)V
...
.method public final onMetadataChanged(Landroid/media/MediaMetadata;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/s;->b(Ljava/lang/Object;)V
...
.method public final onPlaybackStateChanged(Landroid/media/session/PlaybackState;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/s;->a(Ljava/lang/Object;)V
...
.method public final onQueueChanged(Ljava/util/List;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/s;->a(Ljava/util/List;)V
...
.method public final onSessionEvent(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/s;->a()V
