...
.method public static a(Ljava/lang/Object;)Landroid/support/v4/media/MediaDescriptionCompat;
    ...
    .line 341
    :cond_1
    new-instance v8, Landroid/support/v4/media/a;

    invoke-direct {v8}, Landroid/support/v4/media/a;-><init>()V
    ...
    .line 5420
    iput-object v0, v8, Landroid/support/v4/media/a;->a:Ljava/lang/String;
    ...
    .line 6431
    iput-object v0, v8, Landroid/support/v4/media/a;->b:Ljava/lang/CharSequence;
    ...
    .line 7442
    iput-object v0, v8, Landroid/support/v4/media/a;->c:Ljava/lang/CharSequence;
    ...
    .line 8454
    iput-object v0, v8, Landroid/support/v4/media/a;->d:Ljava/lang/CharSequence;
    ...
    .line 9466
    iput-object v0, v8, Landroid/support/v4/media/a;->e:Landroid/graphics/Bitmap;
    ...
    .line 10478
    iput-object v0, v8, Landroid/support/v4/media/a;->f:Landroid/net/Uri;
    ...
    .line 11489
    :goto_2
    iput-object v0, v8, Landroid/support/v4/media/a;->g:Landroid/os/Bundle;

    .line 366
    if-eqz v3, :cond_6

    .line 11500
    iput-object v3, v8, Landroid/support/v4/media/a;->h:Landroid/net/Uri;
    ...
    iget-object v1, v8, Landroid/support/v4/media/a;->a:Ljava/lang/String;

    iget-object v2, v8, Landroid/support/v4/media/a;->b:Ljava/lang/CharSequence;

    iget-object v3, v8, Landroid/support/v4/media/a;->c:Ljava/lang/CharSequence;

    iget-object v4, v8, Landroid/support/v4/media/a;->d:Ljava/lang/CharSequence;

    iget-object v5, v8, Landroid/support/v4/media/a;->e:Landroid/graphics/Bitmap;

    iget-object v6, v8, Landroid/support/v4/media/a;->f:Landroid/net/Uri;

    iget-object v7, v8, Landroid/support/v4/media/a;->g:Landroid/os/Bundle;

    iget-object v8, v8, Landroid/support/v4/media/a;->h:Landroid/net/Uri;
    ...
    .line 12500
    iput-object v0, v8, Landroid/support/v4/media/a;->h:Landroid/net/Uri;
