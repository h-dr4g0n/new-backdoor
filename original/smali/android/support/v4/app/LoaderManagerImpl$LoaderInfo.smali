...
.field mLoader:Landroid/support/v4/content/i;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# virtual methods
.method final callOnLoadFinished(Landroid/support/v4/content/i;Ljava/lang/Object;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1498
    invoke-static {p2, v3}, Landroid/support/v4/e/d;->a(Ljava/lang/Object;Ljava/lang/StringBuilder;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onLoadFinished(Landroid/support/v4/content/i;Ljava/lang/Object;)V
    :try_end_0
...
.method final cancel()Z
    ...
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/content/i;
    ...
    invoke-virtual {v0}, Landroid/support/v4/content/i;->f()Z
    ...
    .line 337
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/content/i;

    invoke-virtual {p0, v1}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->onLoadCanceled(Landroid/support/v4/content/i;)V
...
.method final destroy()V
    ...
    iget-object v3, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/content/i;

    invoke-interface {v0, v3}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onLoaderReset(Landroid/support/v4/content/i;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 1421
    iput-boolean v5, v0, Landroid/support/v4/content/i;->l:Z

    .line 1422
    iput-boolean v4, v0, Landroid/support/v4/content/i;->j:Z

    .line 1423
    iput-boolean v4, v0, Landroid/support/v4/content/i;->k:Z

    .line 1424
    iput-boolean v4, v0, Landroid/support/v4/content/i;->m:Z

    .line 1425
    iput-boolean v4, v0, Landroid/support/v4/content/i;->n:Z
...
.method public final dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p2, p3, p4}, Landroid/support/v4/content/i;->a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method final finishRetain()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->callOnLoadFinished(Landroid/support/v4/content/i;Ljava/lang/Object;)V
...
.method public final onLoadCanceled(Landroid/support/v4/content/i;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, v0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Landroid/support/v4/e/t;

    iget v1, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mId:I

    invoke-virtual {v0, v1}, Landroid/support/v4/e/t;->a(I)Ljava/lang/Object;
    ...
    iget-object v1, v1, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Landroid/support/v4/e/t;

    iget v2, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mId:I

    invoke-virtual {v1, v2, v4}, Landroid/support/v4/e/t;->a(ILjava/lang/Object;)V
...
.method public final onLoadComplete(Landroid/support/v4/content/i;Ljava/lang/Object;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 444
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->callOnLoadFinished(Landroid/support/v4/content/i;Ljava/lang/Object;)V

    .line 454
    :cond_7
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->this$0:Landroid/support/v4/app/LoaderManagerImpl;

    iget-object v0, v0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Landroid/support/v4/e/t;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/e/t;->b(I)V
...
.method final start()V
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onCreateLoader(ILandroid/os/Bundle;)Landroid/support/v4/content/i;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/content/i;
    ...
    iget-object v2, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/content/i;
    ...
    .line 1164
    iget-object v2, v0, Landroid/support/v4/content/i;->g:Landroid/support/v4/content/k;
    ...
    .line 1167
    :cond_5
    iput-object p0, v0, Landroid/support/v4/content/i;->g:Landroid/support/v4/content/k;

    .line 1168
    iput v1, v0, Landroid/support/v4/content/i;->f:I

    .line 267
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/content/i;

    .line 1196
    iget-object v1, v0, Landroid/support/v4/content/i;->h:Landroid/support/v4/content/j;
    ...
    .line 1199
    :cond_6
    iput-object p0, v0, Landroid/support/v4/content/i;->h:Landroid/support/v4/content/j;
    ...
    .line 1269
    iput-boolean v3, v0, Landroid/support/v4/content/i;->j:Z

    .line 1270
    iput-boolean v4, v0, Landroid/support/v4/content/i;->l:Z

    .line 1271
    iput-boolean v4, v0, Landroid/support/v4/content/i;->k:Z

    .line 1272
    invoke-virtual {v0}, Landroid/support/v4/content/i;->e()V
