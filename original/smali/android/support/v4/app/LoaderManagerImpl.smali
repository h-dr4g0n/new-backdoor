...
.field final mInactiveLoaders:Landroid/support/v4/e/t;
...
.field final mLoaders:Landroid/support/v4/e/t;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/support/v4/e/t",
            "<",
...
.method constructor <init>(Ljava/lang/String;Landroid/support/v4/app/FragmentHostCallback;Z)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Landroid/support/v4/e/t;
    ...
    iput-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Landroid/support/v4/e/t;
...
.method private createLoader(ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;
    ...
    .line 539
    invoke-interface {p3, p1, p2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onCreateLoader(ILandroid/os/Bundle;)Landroid/support/v4/content/i;

    move-result-object v1

    .line 540
    iput-object v1, v0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/content/i;
...
.method public destroyLoader(I)V
    ...
    .line 718
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Landroid/support/v4/e/t;

    invoke-virtual {v0, p1}, Landroid/support/v4/e/t;->f(I)I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/e/t;->e(I)Ljava/lang/Object;
    ...
    .line 721
    iget-object v2, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Landroid/support/v4/e/t;

    invoke-virtual {v2, v1}, Landroid/support/v4/e/t;->c(I)V
    ...
    .line 724
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Landroid/support/v4/e/t;
    ...
    .line 727
    iget-object v2, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Landroid/support/v4/e/t;
...
.method doDestroy()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/e/t;->a()I
    ...
    invoke-virtual {v0}, Landroid/support/v4/e/t;->b()V
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v4, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Landroid/support/v4/e/t;

    invoke-virtual {v4, v1}, Landroid/support/v4/e/t;->d(I)I
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/e/t;->e(I)Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Landroid/support/v4/e/t;

    invoke-virtual {v3, v2}, Landroid/support/v4/e/t;->d(I)I
...
.method public getLoader(I)Landroid/support/v4/content/i;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<D:",
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/e/t;->a(I)Ljava/lang/Object;
    ...
    iget-object v0, v0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/content/i;
...
.method public initLoader(ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Landroid/support/v4/content/i;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<D:",
    ...
    .line 612
    iget-object v1, v0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/content/i;

    iget-object v2, v0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mData:Ljava/lang/Object;

    invoke-virtual {v0, v1, v2}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->callOnLoadFinished(Landroid/support/v4/content/i;Ljava/lang/Object;)V
...
.method installLoader(Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;)V
    ...
    invoke-virtual {v0, v1, p1}, Landroid/support/v4/e/t;->a(ILjava/lang/Object;)V
...
.method public restartLoader(ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Landroid/support/v4/content/i;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<D:",
    ...
    .line 651
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Landroid/support/v4/e/t;

    invoke-virtual {v1, p1}, Landroid/support/v4/e/t;->a(I)Ljava/lang/Object;
    ...
    iput-boolean v2, v1, Landroid/support/v4/content/i;->k:Z

    .line 696
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Landroid/support/v4/e/t;

    invoke-virtual {v1, p1, v0}, Landroid/support/v4/e/t;->a(ILjava/lang/Object;)V
    ...
    .line 672
    :cond_6
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Landroid/support/v4/e/t;

    invoke-virtual {v1, p1, v4}, Landroid/support/v4/e/t;->a(ILjava/lang/Object;)V
