...
.field private K:Landroid/support/design/widget/bp;
...
.field final g:Landroid/support/design/widget/t;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/TextInputLayout;->g:Landroid/support/design/widget/t;
    ...
    .line 200
    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->g:Landroid/support/design/widget/t;
    ...
    .line 2126
    iput-object v1, v0, Landroid/support/design/widget/t;->j:Landroid/view/animation/Interpolator;
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/t;->b(I)V

    .line 204
    sget-object v0, Landroid/support/design/l;->TextInputLayout:[I

    sget v1, Landroid/support/design/k;->Widget_Design_TextInputLayout:I
    ...
    .line 206
    sget v1, Landroid/support/design/l;->TextInputLayout_hintEnabled:I

    invoke-virtual {v0, v1, v5}, Landroid/support/v7/widget/ex;->a(IZ)Z
    ...
    .line 207
    sget v1, Landroid/support/design/l;->TextInputLayout_android_hint:I

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ex;->c(I)Ljava/lang/CharSequence;
    ...
    .line 208
    sget v1, Landroid/support/design/l;->TextInputLayout_hintAnimationEnabled:I
    ...
    .line 211
    sget v1, Landroid/support/design/l;->TextInputLayout_android_textColorHint:I
    ...
    .line 216
    :cond_0
    sget v1, Landroid/support/design/l;->TextInputLayout_hintTextAppearance:I

    invoke-virtual {v0, v1, v6}, Landroid/support/v7/widget/ex;->g(II)I
    ...
    .line 220
    invoke-virtual {v0, v1, v4}, Landroid/support/v7/widget/ex;->g(II)I
    ...
    .line 223
    :cond_1
    sget v1, Landroid/support/design/l;->TextInputLayout_errorTextAppearance:I
    ...
    .line 224
    sget v1, Landroid/support/design/l;->TextInputLayout_errorEnabled:I

    invoke-virtual {v0, v1, v4}, Landroid/support/v7/widget/ex;->a(IZ)Z

    move-result v1

    .line 226
    sget v2, Landroid/support/design/l;->TextInputLayout_counterEnabled:I

    invoke-virtual {v0, v2, v4}, Landroid/support/v7/widget/ex;->a(IZ)Z

    move-result v2

    .line 228
    sget v3, Landroid/support/design/l;->TextInputLayout_counterMaxLength:I

    .line 229
    invoke-virtual {v0, v3, v6}, Landroid/support/v7/widget/ex;->a(II)I
    ...
    .line 230
    sget v3, Landroid/support/design/l;->TextInputLayout_counterTextAppearance:I

    invoke-virtual {v0, v3, v4}, Landroid/support/v7/widget/ex;->g(II)I
    ...
    .line 232
    sget v3, Landroid/support/design/l;->TextInputLayout_counterOverflowTextAppearance:I
    ...
    .line 235
    sget v3, Landroid/support/design/l;->TextInputLayout_passwordToggleEnabled:I

    invoke-virtual {v0, v3, v4}, Landroid/support/v7/widget/ex;->a(IZ)Z
    ...
    .line 237
    sget v3, Landroid/support/design/l;->TextInputLayout_passwordToggleDrawable:I

    invoke-virtual {v0, v3}, Landroid/support/v7/widget/ex;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 238
    sget v3, Landroid/support/design/l;->TextInputLayout_passwordToggleContentDescription:I

    invoke-virtual {v0, v3}, Landroid/support/v7/widget/ex;->c(I)Ljava/lang/CharSequence;
    ...
    .line 240
    sget v3, Landroid/support/design/l;->TextInputLayout_passwordToggleTint:I

    invoke-virtual {v0, v3}, Landroid/support/v7/widget/ex;->e(I)Z
    ...
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/ex;->d(I)Landroid/content/res/ColorStateList;
    ...
    .line 245
    :cond_2
    sget v3, Landroid/support/design/l;->TextInputLayout_passwordToggleTintMode:I
    ...
    .line 247
    invoke-static {v3}, Landroid/support/design/widget/cg;->a(I)Landroid/graphics/PorterDuff$Mode;
    ...
    .line 260
    invoke-static {p0, v5}, Landroid/support/v4/view/bj;->c(Landroid/view/View;I)V
...
.method private a(F)V
    ...
    .line 11333
    iget v0, v0, Landroid/support/design/widget/t;->a:F
    ...
    .line 1422
    :cond_0
    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->K:Landroid/support/design/widget/bp;
    ...
    iput-object v0, p0, Landroid/support/design/widget/TextInputLayout;->K:Landroid/support/design/widget/bp;
    ...
    iget-object v1, p0, Landroid/support/design/widget/TextInputLayout;->g:Landroid/support/design/widget/t;

    .line 12333
    iget v1, v1, Landroid/support/design/widget/t;->a:F

    .line 1433
    invoke-virtual {v0, v1, p1}, Landroid/support/design/widget/bp;->a(FF)V
...
.method private b()V
    ...
    iget-object v2, p0, Landroid/support/design/widget/TextInputLayout;->g:Landroid/support/design/widget/t;

    invoke-virtual {v2}, Landroid/support/design/widget/t;->a()Landroid/graphics/Typeface;
    ...
    .line 3337
    iget v2, v2, Landroid/support/design/widget/t;->e:F
...
.method private c()V
    ...
    invoke-static {v1}, Landroid/support/v4/view/bj;->l(Landroid/view/View;)I
    ...
    .line 576
    invoke-static {v3}, Landroid/support/v4/view/bj;->m(Landroid/view/View;)I
    ...
    .line 575
    invoke-static {v0, v1, v2, v3, v4}, Landroid/support/v4/view/bj;->b(Landroid/view/View;IIII)V
...
.method private d()V
    ...
    .line 10042
    invoke-static {v0, v3}, Landroid/support/design/widget/ad;->a(Landroid/graphics/drawable/DrawableContainer;Landroid/graphics/drawable/Drawable$ConstantState;)Z
    ...
    invoke-static {v0, v2}, Landroid/support/v4/view/bj;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 880
    :cond_4
    invoke-static {v1}, Landroid/support/v7/widget/bf;->c(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 887
    invoke-static {v1, v2}, Landroid/support/v7/widget/ae;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method private e()V
    ...
    sget v3, Landroid/support/design/i;->design_text_input_password_icon:I
    ...
    invoke-static {v0}, Landroid/support/v4/widget/bb;->b(Landroid/widget/TextView;)[Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v3, v2, v1, v4, v0}, Landroid/support/v4/widget/bb;->a(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method private setEditText(Landroid/widget/EditText;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/t;->a(Landroid/graphics/Typeface;)V
    ...
    .line 3131
    iget v2, v0, Landroid/support/design/widget/t;->d:F
    ...
    .line 3132
    iput v1, v0, Landroid/support/design/widget/t;->d:F
    ...
    invoke-virtual {v1, v2}, Landroid/support/design/widget/t;->b(I)V

    .line 340
    iget-object v1, p0, Landroid/support/design/widget/TextInputLayout;->g:Landroid/support/design/widget/t;

    invoke-virtual {v1, v0}, Landroid/support/design/widget/t;->a(I)V
...
.method private setHintInternal(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/t;->a(Ljava/lang/CharSequence;)V
...
.method final a(I)V
    ...
    :goto_2
    invoke-static {v4, v0}, Landroid/support/v4/widget/bb;->a(Landroid/widget/TextView;I)V
    ...
    sget v5, Landroid/support/design/j;->character_counter_pattern:I
...
.method final a(ZZ)V
    ...
    .line 419
    iget-object v6, p0, Landroid/support/design/widget/TextInputLayout;->g:Landroid/support/design/widget/t;

    iget-object v7, p0, Landroid/support/design/widget/TextInputLayout;->G:Landroid/content/res/ColorStateList;

    invoke-virtual {v6, v7}, Landroid/support/design/widget/t;->b(Landroid/content/res/ColorStateList;)V
    ...
    .line 423
    iget-object v5, p0, Landroid/support/design/widget/TextInputLayout;->g:Landroid/support/design/widget/t;
    ...
    invoke-virtual {v5, v6}, Landroid/support/design/widget/t;->a(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, v10}, Landroid/support/design/widget/t;->a(F)V
    ...
    invoke-virtual {v0, v9}, Landroid/support/design/widget/t;->a(F)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/t;->a(Landroid/graphics/Canvas;)V
...
.method protected drawableStateChanged()V
    ...
    invoke-virtual {v0, v2}, Landroid/support/design/widget/t;->a([I)Z
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static {p0, v1, v0}, Landroid/support/design/widget/bz;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    .line 1348
    iget-object v3, p0, Landroid/support/design/widget/TextInputLayout;->g:Landroid/support/design/widget/t;
    ...
    .line 1348
    invoke-virtual {v3, v1, v4, v2, v0}, Landroid/support/design/widget/t;->a(IIII)V
    ...
    .line 1354
    invoke-virtual {v0, v1, v3, v2, v4}, Landroid/support/design/widget/t;->b(IIII)V
...
.method public setCounterEnabled(Z)V
    ...
    sget v1, Landroid/support/design/g;->textinput_counter:I
    ...
    invoke-static {v0, v1}, Landroid/support/v4/widget/bb;->a(Landroid/widget/TextView;I)V
    :try_end_0
    ...
    sget v1, Landroid/support/v7/a/j;->TextAppearance_AppCompat_Caption:I
...
.method public setError(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v1}, Landroid/support/v4/view/dd;->a()V
    ...
    invoke-static {v1}, Landroid/support/v4/view/bj;->e(Landroid/view/View;)F
    ...
    invoke-static {v1, v5}, Landroid/support/v4/view/bj;->c(Landroid/view/View;F)V
    ...
    .line 7713
    invoke-virtual {v1, v4}, Landroid/support/v4/view/dd;->a(F)Landroid/support/v4/view/dd;
    ...
    .line 7715
    invoke-virtual {v1, v3}, Landroid/support/v4/view/dd;->a(Landroid/view/animation/Interpolator;)Landroid/support/v4/view/dd;
    ...
    .line 7716
    invoke-virtual {v1, v3}, Landroid/support/v4/view/dd;->a(Landroid/support/v4/view/dq;)Landroid/support/v4/view/dd;
    ...
    invoke-static {v1, v4}, Landroid/support/v4/view/bj;->c(Landroid/view/View;F)V
    ...
    .line 7730
    invoke-virtual {v1, v5}, Landroid/support/v4/view/dd;->a(F)Landroid/support/v4/view/dd;
...
.method public setErrorEnabled(Z)V
    ...
    invoke-virtual {v2}, Landroid/support/v4/view/dd;->a()V
    ...
    sget v3, Landroid/support/design/g;->textinput_error:I
    ...
    invoke-static {v2, v3}, Landroid/support/v4/widget/bb;->a(Landroid/widget/TextView;I)V
    ...
    sget v2, Landroid/support/v7/a/j;->TextAppearance_AppCompat_Caption:I

    invoke-static {v0, v2}, Landroid/support/v4/widget/bb;->a(Landroid/widget/TextView;I)V
    ...
    sget v3, Landroid/support/design/d;->design_textinput_error_color_light:I
    ...
    invoke-static {v0}, Landroid/support/v4/view/bj;->k(Landroid/view/View;)V
...
.method public setErrorTextAppearance(I)V
    ...
    invoke-static {v0, p1}, Landroid/support/v4/widget/bb;->a(Landroid/widget/TextView;I)V
...
.method public setHintTextAppearance(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/t;->c(I)V

    .line 543
    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->g:Landroid/support/design/widget/t;

    .line 6690
    iget-object v0, v0, Landroid/support/design/widget/t;->f:Landroid/content/res/ColorStateList;
...
.method public setTypeface(Landroid/graphics/Typeface;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/t;->a(Landroid/graphics/Typeface;)V
