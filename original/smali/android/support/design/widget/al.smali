...
.method constructor <init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/aw;Landroid/support/design/widget/bt;)V
    ...
    .prologue
    .line 36
    invoke-direct {p0, p1, p2, p3}, Landroid/support/design/widget/ag;-><init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/aw;Landroid/support/design/widget/bt;)V

    .line 37
    iget-object v0, p0, Landroid/support/design/widget/al;->n:Landroid/support/design/widget/VisibilityAwareImageButton;

    invoke-virtual {v0}, Landroid/support/design/widget/VisibilityAwareImageButton;->getRotation()F

    move-result v0

    iput v0, p0, Landroid/support/design/widget/al;->r:F
...
# virtual methods
.method final a(Landroid/support/design/widget/an;Z)V
    .locals 4
    ...
    .line 56
    invoke-virtual {p0}, Landroid/support/design/widget/al;->k()Z
    ...
    .line 63
    invoke-direct {p0}, Landroid/support/design/widget/al;->l()Z
    ...
    iput v0, p0, Landroid/support/design/widget/al;->c:I
    ...
    new-instance v1, Landroid/support/design/widget/al$1;

    invoke-direct {v1, p0, p2, p1}, Landroid/support/design/widget/al$1;-><init>(Landroid/support/design/widget/al;ZLandroid/support/design/widget/an;)V
    ...
    .line 101
    :cond_1
    iget-object v1, p0, Landroid/support/design/widget/al;->n:Landroid/support/design/widget/VisibilityAwareImageButton;
...
.method final b(Landroid/support/design/widget/an;Z)V
    .locals 4
    ...
    .line 110
    invoke-virtual {p0}, Landroid/support/design/widget/al;->j()Z
    ...
    new-instance v1, Landroid/support/design/widget/al$2;

    invoke-direct {v1, p0, p2, p1}, Landroid/support/design/widget/al$2;-><init>(Landroid/support/design/widget/al;ZLandroid/support/design/widget/an;)V
...
.method final e()V
    ...
    .line 48
    iget v1, p0, Landroid/support/design/widget/al;->r:F
    ...
    .line 1166
    iget v0, p0, Landroid/support/design/widget/al;->r:F
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Landroid/support/design/widget/al;->a:Landroid/support/design/widget/av;
    ...
    .line 1202
    iget v2, v0, Landroid/support/design/widget/av;->l:F
    ...
    .line 1203
    iput v1, v0, Landroid/support/design/widget/av;->l:F
    ...
    .line 1181
    :cond_1
    iget-object v0, p0, Landroid/support/design/widget/al;->f:Landroid/support/design/widget/r;
    ...
    .line 2146
    iget v2, v0, Landroid/support/design/widget/r;->j:F
    ...
    .line 2147
    iput v1, v0, Landroid/support/design/widget/r;->j:F

    .line 2148
    invoke-virtual {v0}, Landroid/support/design/widget/r;->invalidateSelf()V
