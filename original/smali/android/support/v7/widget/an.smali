...
.method public constructor <init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .prologue
    .line 704
    iput-object p1, p0, Landroid/support/v7/widget/an;->d:Landroid/support/v7/widget/AppCompatSpinner;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/an;->c:Landroid/graphics/Rect;
    ...
    invoke-direct {v0, p0, p1}, Landroid/support/v7/widget/an$1;-><init>(Landroid/support/v7/widget/an;Landroid/support/v7/widget/AppCompatSpinner;)V
...
.method final a()V
    ...
    .line 743
    iget-object v0, p0, Landroid/support/v7/widget/an;->d:Landroid/support/v7/widget/AppCompatSpinner;
    ...
    invoke-static {v0}, Landroid/support/v7/widget/fk;->a(Landroid/view/View;)Z
    ...
    .line 754
    iget-object v2, p0, Landroid/support/v7/widget/an;->d:Landroid/support/v7/widget/AppCompatSpinner;

    iget-object v0, p0, Landroid/support/v7/widget/an;->b:Landroid/widget/ListAdapter;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/an;->d:Landroid/support/v7/widget/AppCompatSpinner;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/an;->b(I)V
    ...
    .line 747
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/an;->d:Landroid/support/v7/widget/AppCompatSpinner;
...
.method public final a(Landroid/widget/ListAdapter;)V
    ...
    .line 727
    iput-object p1, p0, Landroid/support/v7/widget/an;->b:Landroid/widget/ListAdapter;
...
.method public final d()V
    ...
    .line 781
    invoke-virtual {p0}, Landroid/support/v7/widget/an;->h()V

    .line 782
    invoke-super {p0}, Landroid/support/v7/widget/ListPopupWindow;->d()V

    .line 5915
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->e:Landroid/support/v7/widget/bg;
    ...
    .line 6797
    iget-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->e:Landroid/support/v7/widget/bg;
    ...
    invoke-virtual {v2, v3}, Landroid/support/v7/widget/bg;->setListSelectionHidden(Z)V

    .line 6800
    invoke-virtual {v2, v1}, Landroid/support/v7/widget/bg;->setSelection(I)V
    ...
    .line 6803
    invoke-virtual {v2}, Landroid/support/v7/widget/bg;->getChoiceMode()I
    ...
    .line 6804
    invoke-virtual {v2, v1, v5}, Landroid/support/v7/widget/bg;->setItemChecked(IZ)V
    ...
    invoke-direct {v1, p0}, Landroid/support/v7/widget/an$2;-><init>(Landroid/support/v7/widget/an;)V
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/an$3;-><init>(Landroid/support/v7/widget/an;Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/an;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
