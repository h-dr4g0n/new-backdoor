...
.field private final D:Landroid/support/v7/widget/cl;

.field private final E:Landroid/support/v7/widget/ck;

.field private final F:Landroid/support/v7/widget/ci;
...
.field public e:Landroid/support/v7/widget/bg;
...
.field final m:Landroid/support/v7/widget/cm;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/cm;-><init>(Landroid/support/v7/widget/ListPopupWindow;)V

    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->m:Landroid/support/v7/widget/cm;

    .line 135
    new-instance v0, Landroid/support/v7/widget/cl;

    invoke-direct {v0, p0}, Landroid/support/v7/widget/cl;-><init>(Landroid/support/v7/widget/ListPopupWindow;)V

    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->D:Landroid/support/v7/widget/cl;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->E:Landroid/support/v7/widget/ck;

    .line 137
    new-instance v0, Landroid/support/v7/widget/ci;

    invoke-direct {v0, p0}, Landroid/support/v7/widget/ci;-><init>(Landroid/support/v7/widget/ListPopupWindow;)V

    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->F:Landroid/support/v7/widget/ci;
...
.method public a(Landroid/widget/ListAdapter;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/cj;-><init>(Landroid/support/v7/widget/ListPopupWindow;)V
    ...
    .line 293
    :cond_1
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->e:Landroid/support/v7/widget/bg;
...
.method public d()V
    ...
    :goto_0
    invoke-virtual {p0, v4, v0}, Landroid/support/v7/widget/ListPopupWindow;->a(Landroid/content/Context;Z)Landroid/support/v7/widget/bg;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->e:Landroid/support/v7/widget/bg;
    ...
    invoke-virtual {v0, v5}, Landroid/support/v7/widget/bg;->setSelector(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, v5}, Landroid/support/v7/widget/bg;->setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {v0, v5}, Landroid/support/v7/widget/bg;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v0, v5}, Landroid/support/v7/widget/bg;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V

    .line 2171
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->e:Landroid/support/v7/widget/bg;

    iget-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->E:Landroid/support/v7/widget/ck;

    invoke-virtual {v0, v5}, Landroid/support/v7/widget/bg;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V
    ...
    invoke-static {v3, v4}, Landroid/support/v4/widget/aj;->a(Landroid/widget/PopupWindow;I)V
    ...
    .line 2288
    :goto_e
    iget-object v7, p0, Landroid/support/v7/widget/ListPopupWindow;->e:Landroid/support/v7/widget/bg;

    sub-int/2addr v5, v0

    invoke-virtual {v7, v3, v5}, Landroid/support/v7/widget/bg;->a(II)I
    ...
    .line 2291
    iget-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->e:Landroid/support/v7/widget/bg;

    invoke-virtual {v5}, Landroid/support/v7/widget/bg;->getPaddingTop()I
    ...
    .line 2292
    invoke-virtual {v7}, Landroid/support/v7/widget/bg;->getPaddingBottom()I
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->D:Landroid/support/v7/widget/cl;
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/bg;->setSelection(I)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->F:Landroid/support/v7/widget/ci;
...
.method public final e()V
    ...
    .line 742
    iput-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->e:Landroid/support/v7/widget/bg;

    .line 743
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->n:Landroid/os/Handler;

    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->m:Landroid/support/v7/widget/cm;
