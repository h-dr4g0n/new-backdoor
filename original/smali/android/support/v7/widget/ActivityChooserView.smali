...
.field g:Landroid/support/v4/view/j;
...
.field private final m:Landroid/support/v7/widget/y;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 218
    sget-object v0, Landroid/support/v7/a/k;->ActivityChooserView:[I
    ...
    .line 221
    sget v1, Landroid/support/v7/a/k;->ActivityChooserView_initialActivityCount:I
    ...
    .line 225
    sget v1, Landroid/support/v7/a/k;->ActivityChooserView_expandActivityOverflowButtonDrawable:I
    ...
    .line 231
    sget v2, Landroid/support/v7/a/h;->abc_activity_chooser_view:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->m:Landroid/support/v7/widget/y;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActivityChooserView;->m:Landroid/support/v7/widget/y;
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/x;-><init>(Landroid/support/v7/widget/ActivityChooserView;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Landroid/support/v7/widget/x;

    .line 269
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Landroid/support/v7/widget/x;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/x;->registerDataSetObserver(Landroid/database/DataSetObserver;)V
...
.method final a(I)V
    ...
    .line 4826
    iget-object v0, v0, Landroid/support/v7/widget/x;->a:Landroid/support/v7/widget/r;
    ...
    .line 362
    :goto_0
    iget-object v3, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Landroid/support/v7/widget/x;

    .line 5818
    iget-object v3, v3, Landroid/support/v7/widget/x;->a:Landroid/support/v7/widget/r;
    ...
    invoke-virtual {v3, v1}, Landroid/support/v7/widget/x;->a(Z)V
    ...
    invoke-virtual {v3, v4}, Landroid/support/v7/widget/x;->a(I)V
    ...
    .line 376
    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Landroid/support/v7/widget/x;

    invoke-virtual {v2, v1, v0}, Landroid/support/v7/widget/x;->a(ZZ)V
    ...
    .line 383
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->g:Landroid/support/v4/view/j;
    ...
    .line 5915
    :cond_2
    iget-object v0, v3, Landroid/support/v7/widget/ListPopupWindow;->e:Landroid/support/v7/widget/bg;
    ...
    invoke-virtual {v3, v2}, Landroid/support/v7/widget/x;->a(Z)V

    .line 370
    iget-object v3, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Landroid/support/v7/widget/x;

    invoke-virtual {v3, p1}, Landroid/support/v7/widget/x;->a(I)V
    ...
    invoke-virtual {v0, v2, v2}, Landroid/support/v7/widget/x;->a(ZZ)V
...
.method public getDataModel()Landroid/support/v7/widget/r;
    .locals 1
...
.method getListPopupWindow()Landroid/support/v7/widget/ListPopupWindow;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Landroid/support/v7/widget/x;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->m:Landroid/support/v7/widget/y;
...
.method protected onAttachedToWindow()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/r;->registerObserver(Ljava/lang/Object;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/r;->unregisterObserver(Ljava/lang/Object;)V
...
.method public setActivityChooserModel(Landroid/support/v7/widget/r;)V
    .locals 3
    ...
    .line 1676
    iget-object v1, v0, Landroid/support/v7/widget/x;->c:Landroid/support/v7/widget/ActivityChooserView;

    iget-object v1, v1, Landroid/support/v7/widget/ActivityChooserView;->a:Landroid/support/v7/widget/x;

    .line 1826
    iget-object v1, v1, Landroid/support/v7/widget/x;->a:Landroid/support/v7/widget/r;

    .line 1677
    if-eqz v1, :cond_0

    iget-object v2, v0, Landroid/support/v7/widget/x;->c:Landroid/support/v7/widget/ActivityChooserView;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/widget/r;->unregisterObserver(Ljava/lang/Object;)V

    .line 1680
    :cond_0
    iput-object p1, v0, Landroid/support/v7/widget/x;->a:Landroid/support/v7/widget/r;
    ...
    invoke-virtual {p1, v1}, Landroid/support/v7/widget/r;->registerObserver(Ljava/lang/Object;)V
...
.method public setProvider(Landroid/support/v4/view/j;)V
    ...
    .prologue
    .line 330
    iput-object p1, p0, Landroid/support/v7/widget/ActivityChooserView;->g:Landroid/support/v4/view/j;
