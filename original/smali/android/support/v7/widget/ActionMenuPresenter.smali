...
.field i:Landroid/support/v7/widget/j;
...
.field m:Landroid/support/v7/widget/k;

.field n:Landroid/support/v7/widget/g;

.field o:Landroid/support/v7/widget/i;

.field final p:Landroid/support/v7/widget/l;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->p:Landroid/support/v7/widget/l;
...
.method static synthetic a(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/view/menu/l;
    ...
    .prologue
    .line 53
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->c:Landroid/support/v7/view/menu/l;
...
.method static synthetic c(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/view/menu/ab;
    .locals 1

    .prologue
    .line 53
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->g:Landroid/support/v7/view/menu/ab;
...
.method static synthetic f(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/view/menu/ab;
    .locals 1
...
.method public final a(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/ab;
    ...
    .line 186
    invoke-super {p0, p1}, Landroid/support/v7/view/menu/d;->a(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/ab;
...
.method public final a(Landroid/support/v7/view/menu/p;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    .locals 3
    ...
    .line 204
    invoke-static {v1}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/o;
...
.method public final a(Landroid/content/Context;Landroid/support/v7/view/menu/l;)V
    ...
    .line 93
    invoke-super {p0, p1, p2}, Landroid/support/v7/view/menu/d;->a(Landroid/content/Context;Landroid/support/v7/view/menu/l;)V
    ...
    .line 113
    iget-object v3, p0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Landroid/support/v7/widget/j;
    ...
    invoke-direct {v3, p0, v4}, Landroid/support/v7/widget/j;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;)V

    iput-object v3, p0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Landroid/support/v7/widget/j;
    ...
    invoke-virtual {v3, v4}, Landroid/support/v7/widget/j;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v3, v1, v1}, Landroid/support/v7/widget/j;->measure(II)V

    .line 123
    :cond_5
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Landroid/support/v7/widget/j;
    ...
    invoke-static {v4}, Landroid/support/v4/view/ca;->a(Landroid/view/ViewConfiguration;)Z
    ...
    .line 125
    :cond_7
    iput-object v6, p0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Landroid/support/v7/widget/j;
...
.method public final a(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/l;->findItem(I)Landroid/view/MenuItem;
    ...
    .line 586
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Landroid/support/v7/view/menu/ah;)Z
...
.method public final a(Landroid/support/v7/view/menu/l;Z)V
    ...
    .line 565
    invoke-super {p0, p1, p2}, Landroid/support/v7/view/menu/d;->a(Landroid/support/v7/view/menu/l;Z)V

    .line 566
    return-void
.end method

.method public final a(Landroid/support/v7/view/menu/p;Landroid/support/v7/view/menu/ac;)V
    .locals 1

    .prologue
    .line 211
    invoke-interface {p2, p1}, Landroid/support/v7/view/menu/ac;->a(Landroid/support/v7/view/menu/p;)V
    ...
    .line 215
    invoke-virtual {p2, v0}, Landroid/support/v7/view/menu/ActionMenuItemView;->setItemInvoker(Landroid/support/v7/view/menu/n;)V

    .line 217
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->C:Landroid/support/v7/widget/h;
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/h;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->C:Landroid/support/v7/widget/h;
...
.method public final a(Landroid/support/v7/widget/ActionMenuView;)V
    ...
    .prologue
    .line 602
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->g:Landroid/support/v7/view/menu/ab;

    .line 603
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->c:Landroid/support/v7/view/menu/l;

    .line 6635
    iput-object v0, p1, Landroid/support/v7/widget/ActionMenuView;->a:Landroid/support/v7/view/menu/l;
...
.method public final a(Z)V
    ...
    .line 2187
    invoke-virtual {v0}, Landroid/support/v7/view/menu/l;->i()V

    .line 2188
    iget-object v4, v0, Landroid/support/v7/view/menu/l;->d:Ljava/util/ArrayList;
    ...
    .line 2654
    iget-object v0, v0, Landroid/support/v7/view/menu/p;->d:Landroid/support/v4/view/j;

    .line 243
    if-eqz v0, :cond_0

    .line 3288
    iput-object p0, v0, Landroid/support/v4/view/j;->a:Landroid/support/v4/view/k;
    ...
    .line 263
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Landroid/support/v7/widget/j;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/j;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Landroid/support/v7/widget/j;

    .line 266
    :cond_3
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Landroid/support/v7/widget/j;

    invoke-virtual {v0}, Landroid/support/v7/widget/j;->getParent()Landroid/view/ViewParent;
    ...
    .line 267
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->g:Landroid/support/v7/view/menu/ab;
    ...
    invoke-static {}, Landroid/support/v7/widget/ActionMenuView;->a()Landroid/support/v7/widget/o;
...
.method public final a()Z
    ...
    iget-object v2, v0, Landroid/support/v7/widget/ActionMenuPresenter;->c:Landroid/support/v7/view/menu/l;
    ...
    invoke-virtual {v2}, Landroid/support/v7/view/menu/l;->h()Ljava/util/ArrayList;
    ...
    iget-object v2, v0, Landroid/support/v7/widget/ActionMenuPresenter;->g:Landroid/support/v7/view/menu/ab;
    ...
    .line 442
    invoke-virtual {v3}, Landroid/support/v7/view/menu/p;->h()Z
    ...
    .line 444
    :cond_1
    invoke-virtual {v3}, Landroid/support/v7/view/menu/p;->g()Z
    ...
    invoke-virtual {v0, v4, v3, v2}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Landroid/support/v7/view/menu/p;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {v4, v9}, Landroid/support/v7/view/menu/p;->c(Z)V
    ...
    .line 499
    :cond_9
    invoke-virtual {v4}, Landroid/support/v7/view/menu/p;->g()Z
    ...
    invoke-virtual {v0, v4, v10, v2}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Landroid/support/v7/view/menu/p;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 553
    :cond_f
    invoke-virtual {v4, v14}, Landroid/support/v7/view/menu/p;->c(Z)V
    ...
    .line 545
    invoke-virtual {v3}, Landroid/support/v7/view/menu/p;->f()Z
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/view/menu/p;->c(Z)V
    ...
    invoke-virtual {v4, v3}, Landroid/support/v7/view/menu/p;->c(Z)V
...
.method public final a(Landroid/support/v7/view/menu/ah;)Z
    ...
    .line 4068
    :goto_1
    iget-object v1, v0, Landroid/support/v7/view/menu/ah;->l:Landroid/support/v7/view/menu/l;

    .line 291
    iget-object v2, p0, Landroid/support/v7/widget/ActionMenuPresenter;->c:Landroid/support/v7/view/menu/l;

    if-eq v1, v2, :cond_2

    .line 5068
    iget-object v0, v0, Landroid/support/v7/view/menu/ah;->l:Landroid/support/v7/view/menu/l;
    ...
    .line 5330
    instance-of v1, v2, Landroid/support/v7/view/menu/ac;

    if-eqz v1, :cond_3

    move-object v1, v2

    check-cast v1, Landroid/support/v7/view/menu/ac;

    .line 5331
    invoke-interface {v1}, Landroid/support/v7/view/menu/ac;->getItemData()Landroid/support/v7/view/menu/p;
    ...
    .line 303
    invoke-virtual {p1}, Landroid/support/v7/view/menu/ah;->getItem()Landroid/view/MenuItem;
    ...
    .line 306
    invoke-virtual {p1}, Landroid/support/v7/view/menu/ah;->size()I
    ...
    .line 308
    invoke-virtual {p1, v0}, Landroid/support/v7/view/menu/ah;->getItem(I)Landroid/view/MenuItem;
    ...
    invoke-direct {v1, p0, v4, p1, v2}, Landroid/support/v7/widget/g;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;Landroid/support/v7/view/menu/ah;Landroid/view/View;)V

    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->n:Landroid/support/v7/widget/g;

    .line 316
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->n:Landroid/support/v7/widget/g;

    invoke-virtual {v1, v0}, Landroid/support/v7/widget/g;->a(Z)V

    .line 317
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->n:Landroid/support/v7/widget/g;

    .line 6141
    invoke-virtual {v0}, Landroid/support/v7/view/menu/y;->b()Z
    ...
    .line 319
    :cond_6
    invoke-super {p0, p1}, Landroid/support/v7/view/menu/d;->a(Landroid/support/v7/view/menu/ah;)Z
...
.method public final b(Z)V
    ...
    invoke-super {p0, v0}, Landroid/support/v7/view/menu/d;->a(Landroid/support/v7/view/menu/ah;)Z
...
.method public final c(Landroid/support/v7/view/menu/p;)Z
    .locals 1
...
.method public final f()Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->o:Landroid/support/v7/widget/i;
    ...
    invoke-direct {v0, p0, v1, v2, v3}, Landroid/support/v7/widget/k;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;Landroid/support/v7/view/menu/l;Landroid/view/View;)V

    .line 346
    new-instance v1, Landroid/support/v7/widget/i;

    invoke-direct {v1, p0, v0}, Landroid/support/v7/widget/i;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/support/v7/widget/k;)V

    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->o:Landroid/support/v7/widget/i;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->o:Landroid/support/v7/widget/i;
...
.method public final g()Z
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionMenuPresenter;->o:Landroid/support/v7/widget/i;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->o:Landroid/support/v7/widget/i;
    ...
    .line 371
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->m:Landroid/support/v7/widget/k;
