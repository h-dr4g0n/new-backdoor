...
.field d:Landroid/support/v7/view/menu/m;

.field e:Landroid/support/v7/widget/q;

.field private f:Landroid/content/Context;

.field private g:I

.field private h:Landroid/support/v7/view/menu/aa;
...
.method static a(Landroid/view/View;IIII)I
    ...
    :cond_2
    :goto_2
    iget-boolean v3, v0, Landroid/support/v7/widget/o;->a:Z
    ...
    .line 427
    :cond_3
    iput-boolean v2, v0, Landroid/support/v7/widget/o;->d:Z
...
.method public static a()Landroid/support/v7/widget/o;
    .locals 2
    ...
    .prologue
    .line 615
    invoke-static {}, Landroid/support/v7/widget/ActionMenuView;->d()Landroid/support/v7/widget/o;
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/o;->a:Z

    .line 617
    return-object v0
.end method

.method protected static a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/o;
    .locals 2
    ...
    .line 596
    instance-of v0, p0, Landroid/support/v7/widget/o;

    if-eqz v0, :cond_1

    new-instance v0, Landroid/support/v7/widget/o;

    check-cast p0, Landroid/support/v7/widget/o;

    invoke-direct {v0, p0}, Landroid/support/v7/widget/o;-><init>(Landroid/support/v7/widget/o;)V

    .line 599
    :goto_0
    iget v1, v0, Landroid/support/v7/widget/o;->h:I
    ...
    iput v1, v0, Landroid/support/v7/widget/o;->h:I
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/o;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method private b(Landroid/util/AttributeSet;)Landroid/support/v7/widget/o;
    .locals 2
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/v7/widget/o;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method private b(I)Z
    ...
    instance-of v3, v0, Landroid/support/v7/widget/m;
    ...
    instance-of v0, v1, Landroid/support/v7/widget/m;
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/m;->c()Z
...
.method private static d()Landroid/support/v7/widget/o;
    .locals 2
...
# virtual methods
.method public final synthetic a(Landroid/util/AttributeSet;)Landroid/support/v7/widget/cd;
    .locals 1

    .prologue
    .line 47
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ActionMenuView;->b(Landroid/util/AttributeSet;)Landroid/support/v7/widget/o;
...
.method public final a(Landroid/support/v7/view/menu/aa;Landroid/support/v7/view/menu/m;)V
    ...
    .prologue
    .line 668
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->h:Landroid/support/v7/view/menu/aa;

    .line 669
    iput-object p2, p0, Landroid/support/v7/widget/ActionMenuView;->d:Landroid/support/v7/view/menu/m;
...
.method public final a(Landroid/support/v7/view/menu/l;)V
    ...
    .prologue
    .line 635
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Landroid/support/v7/view/menu/l;
...
.method public final a(Landroid/support/v7/view/menu/p;)Z
    ...
    .prologue
    .line 623
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->a:Landroid/support/v7/view/menu/l;
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroid/support/v7/view/menu/l;->a(Landroid/view/MenuItem;Landroid/support/v7/view/menu/z;I)Z
...
.method protected final synthetic b(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/cd;
    .locals 1

    .prologue
    .line 47
    invoke-static {p1}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/o;
...
.method protected final synthetic c()Landroid/support/v7/widget/cd;
    .locals 1
...
.method public getMenu()Landroid/view/Menu;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Landroid/support/v7/view/menu/l;

    .line 650
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Landroid/support/v7/view/menu/l;

    new-instance v2, Landroid/support/v7/widget/p;

    invoke-direct {v2, p0}, Landroid/support/v7/widget/p;-><init>(Landroid/support/v7/widget/ActionMenuView;)V

    invoke-virtual {v1, v2}, Landroid/support/v7/view/menu/l;->a(Landroid/support/v7/view/menu/m;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->h:Landroid/support/v7/view/menu/aa;
    ...
    .line 3152
    :goto_0
    iput-object v0, v1, Landroid/support/v7/view/menu/d;->f:Landroid/support/v7/view/menu/aa;
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/n;-><init>(Landroid/support/v7/widget/ActionMenuView;)V
...
.method public getOverflowIcon()Landroid/graphics/drawable/Drawable;
    ...
    .line 2175
    iget-object v1, v0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Landroid/support/v7/widget/j;

    if-eqz v1, :cond_0

    .line 2176
    iget-object v0, v0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Landroid/support/v7/widget/j;

    invoke-virtual {v0}, Landroid/support/v7/widget/j;->getDrawable()Landroid/graphics/drawable/Drawable;
...
.method protected onLayout(ZIIII)V
    ...
    .line 459
    iget-boolean v1, v0, Landroid/support/v7/widget/o;->a:Z
    ...
    iget v0, v0, Landroid/support/v7/widget/o;->leftMargin:I
    ...
    iget v0, v0, Landroid/support/v7/widget/o;->rightMargin:I
    ...
    iget v10, v0, Landroid/support/v7/widget/o;->leftMargin:I
    ...
    iget-boolean v5, v0, Landroid/support/v7/widget/o;->a:Z

    if-nez v5, :cond_b

    .line 515
    iget v5, v0, Landroid/support/v7/widget/o;->rightMargin:I
    ...
    .line 531
    iget v5, v0, Landroid/support/v7/widget/o;->leftMargin:I
...
.method protected onMeasure(II)V
    ...
    iget-object v7, v0, Landroid/support/v7/widget/ActionMenuView;->a:Landroid/support/v7/view/menu/l;
    ...
    iget-object v6, v0, Landroid/support/v7/widget/ActionMenuView;->a:Landroid/support/v7/view/menu/l;

    const/4 v7, 0x1

    invoke-virtual {v6, v7}, Landroid/support/v7/view/menu/l;->a(Z)V
    ...
    iput-boolean v7, v6, Landroid/support/v7/widget/o;->f:Z

    .line 1227
    const/4 v7, 0x0

    iput v7, v6, Landroid/support/v7/widget/o;->c:I

    .line 1228
    const/4 v7, 0x0

    iput v7, v6, Landroid/support/v7/widget/o;->b:I

    .line 1229
    const/4 v7, 0x0

    iput-boolean v7, v6, Landroid/support/v7/widget/o;->d:Z

    .line 1230
    const/4 v7, 0x0

    iput v7, v6, Landroid/support/v7/widget/o;->leftMargin:I

    .line 1231
    const/4 v7, 0x0

    iput v7, v6, Landroid/support/v7/widget/o;->rightMargin:I
    ...
    :goto_3
    iput-boolean v7, v6, Landroid/support/v7/widget/o;->e:Z

    .line 1235
    iget-boolean v7, v6, Landroid/support/v7/widget/o;->a:Z
    ...
    .line 1241
    iget-boolean v7, v6, Landroid/support/v7/widget/o;->d:Z
    ...
    .line 1242
    :goto_5
    iget-boolean v6, v6, Landroid/support/v7/widget/o;->a:Z
    ...
    .line 1266
    iget-boolean v0, v6, Landroid/support/v7/widget/o;->d:Z
    ...
    .line 1269
    iget v0, v6, Landroid/support/v7/widget/o;->b:I
    ...
    .line 1270
    iget v9, v6, Landroid/support/v7/widget/o;->b:I
    ...
    .line 1273
    :cond_9
    iget v6, v6, Landroid/support/v7/widget/o;->b:I
    ...
    iget-boolean v0, v6, Landroid/support/v7/widget/o;->e:Z
    ...
    iput v0, v6, Landroid/support/v7/widget/o;->b:I
    ...
    iput-boolean v0, v6, Landroid/support/v7/widget/o;->f:Z
    ...
    .line 1320
    iget-boolean v6, v6, Landroid/support/v7/widget/o;->e:Z
    ...
    iput-boolean v8, v6, Landroid/support/v7/widget/o;->f:Z

    .line 1340
    if-nez v9, :cond_11

    iget-boolean v8, v6, Landroid/support/v7/widget/o;->e:Z
    ...
    iput v8, v6, Landroid/support/v7/widget/o;->leftMargin:I
    ...
    .line 1346
    :cond_14
    iget-boolean v10, v6, Landroid/support/v7/widget/o;->a:Z
    ...
    iput v8, v6, Landroid/support/v7/widget/o;->rightMargin:I
    ...
    iput v10, v6, Landroid/support/v7/widget/o;->leftMargin:I
    ...
    iput v10, v6, Landroid/support/v7/widget/o;->rightMargin:I
    ...
    .line 1373
    iget-boolean v9, v6, Landroid/support/v7/widget/o;->f:Z
    ...
    iget v6, v6, Landroid/support/v7/widget/o;->c:I
    ...
    iput v9, v6, Landroid/support/v7/widget/o;->rightMargin:I

    iput v9, v6, Landroid/support/v7/widget/o;->leftMargin:I
...
.method public setOnMenuItemClickListener(Landroid/support/v7/widget/q;)V
    .locals 0

    .prologue
    .line 140
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->e:Landroid/support/v7/widget/q;
...
.method public setOverflowIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/j;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
