...
.field private k:Landroid/support/v4/view/dd;

.field private l:Landroid/support/v4/widget/ag;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    .line 87
    iput-boolean p2, p0, Landroid/support/v7/widget/bg;->i:Z
...
.method public a(Landroid/view/MotionEvent;I)Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/bg;->j:Z

    .line 3175
    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/bg;->setPressed(Z)V
    ...
    .line 3184
    :cond_2
    iget-object v0, p0, Landroid/support/v7/widget/bg;->k:Landroid/support/v4/view/dd;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/bg;->k:Landroid/support/v4/view/dd;
    ...
    .line 141
    iget-object v0, p0, Landroid/support/v7/widget/bg;->l:Landroid/support/v4/widget/ag;
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/ag;-><init>(Landroid/widget/ListView;)V

    iput-object v0, p0, Landroid/support/v7/widget/bg;->l:Landroid/support/v4/widget/ag;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/widget/ag;->a(Z)Landroid/support/v4/widget/a;

    .line 145
    iget-object v0, p0, Landroid/support/v7/widget/bg;->l:Landroid/support/v4/widget/ag;

    invoke-virtual {v0, p0, p1}, Landroid/support/v4/widget/ag;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    .line 118
    invoke-virtual {p0, v4, v2}, Landroid/support/v7/widget/bg;->pointToPosition(II)I
    ...
    .line 1195
    invoke-virtual {p0, v4, v7}, Landroid/support/v7/widget/bg;->drawableHotspotChanged(FF)V
    ...
    .line 1212
    :cond_a
    iput v5, p0, Landroid/support/v7/widget/bg;->f:I
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/bg;->setSelectorEnabled(Z)V
    ...
    .line 3158
    invoke-virtual {p0, v5}, Landroid/support/v7/widget/bg;->getItemIdAtPosition(I)J

    move-result-wide v2

    .line 3159
    invoke-virtual {p0, v6, v5, v2, v3}, Landroid/support/v7/widget/bg;->performItemClick(Landroid/view/View;IJ)Z
