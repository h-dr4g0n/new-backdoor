...
.field public f:Landroid/support/v7/view/menu/aa;

.field protected g:Landroid/support/v7/view/menu/ab;
...
# virtual methods
.method public a(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/ab;
    .locals 3

    .prologue
    .line 77
    iget-object v0, p0, Landroid/support/v7/view/menu/d;->g:Landroid/support/v7/view/menu/ab;
    ...
    check-cast v0, Landroid/support/v7/view/menu/ab;

    iput-object v0, p0, Landroid/support/v7/view/menu/d;->g:Landroid/support/v7/view/menu/ab;

    .line 79
    iget-object v0, p0, Landroid/support/v7/view/menu/d;->g:Landroid/support/v7/view/menu/ab;

    iget-object v1, p0, Landroid/support/v7/view/menu/d;->c:Landroid/support/v7/view/menu/l;

    invoke-interface {v0, v1}, Landroid/support/v7/view/menu/ab;->a(Landroid/support/v7/view/menu/l;)V
...
.method public a(Landroid/support/v7/view/menu/p;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .prologue
    .line 181
    instance-of v0, p2, Landroid/support/v7/view/menu/ac;

    if-eqz v0, :cond_0

    .line 182
    check-cast p2, Landroid/support/v7/view/menu/ac;

    move-object v0, p2

    .line 186
    :goto_0
    invoke-virtual {p0, p1, v0}, Landroid/support/v7/view/menu/d;->a(Landroid/support/v7/view/menu/p;Landroid/support/v7/view/menu/ac;)V
...
.method public a(Landroid/content/Context;Landroid/support/v7/view/menu/l;)V
    ...
    .line 72
    iput-object p2, p0, Landroid/support/v7/view/menu/d;->c:Landroid/support/v7/view/menu/l;
...
.method public final a(Landroid/support/v7/view/menu/aa;)V
    ...
    .prologue
    .line 152
    iput-object p1, p0, Landroid/support/v7/view/menu/d;->f:Landroid/support/v7/view/menu/aa;
...
.method public a(Landroid/support/v7/view/menu/l;Z)V
    ...
    .prologue
    .line 210
    iget-object v0, p0, Landroid/support/v7/view/menu/d;->f:Landroid/support/v7/view/menu/aa;
...
.method public abstract a(Landroid/support/v7/view/menu/p;Landroid/support/v7/view/menu/ac;)V
.end method
...
.method public a(Z)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/view/menu/l;->i()V
    ...
    .line 100
    invoke-virtual {p0, v1}, Landroid/support/v7/view/menu/d;->c(Landroid/support/v7/view/menu/p;)Z
    ...
    .line 102
    instance-of v2, v3, Landroid/support/v7/view/menu/ac;

    if-eqz v2, :cond_5

    move-object v2, v3

    check-cast v2, Landroid/support/v7/view/menu/ac;

    .line 103
    invoke-interface {v2}, Landroid/support/v7/view/menu/ac;->getItemData()Landroid/support/v7/view/menu/p;
    ...
    .line 108
    invoke-static {v9}, Landroid/support/v4/view/bj;->y(Landroid/view/View;)V
    ...
    .line 1137
    :cond_3
    iget-object v1, p0, Landroid/support/v7/view/menu/d;->g:Landroid/support/v7/view/menu/ab;
...
.method public a(Landroid/support/v7/view/menu/ah;)Z
    .locals 1
