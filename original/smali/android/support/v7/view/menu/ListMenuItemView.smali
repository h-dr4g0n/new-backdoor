...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, p2, v1, p3, v3}, Landroid/support/v7/widget/ex;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/ex;
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/ex;->g(II)I
...
.method private setShortcut$25d965e(Z)V
    ...
    .line 4299
    invoke-virtual {v0}, Landroid/support/v7/view/menu/p;->c()C
    ...
    sget-object v4, Landroid/support/v7/view/menu/p;->f:Ljava/lang/String;
    ...
    .line 4308
    :sswitch_0
    sget-object v0, Landroid/support/v7/view/menu/p;->g:Ljava/lang/String;
    ...
    .line 4312
    :sswitch_1
    sget-object v0, Landroid/support/v7/view/menu/p;->h:Ljava/lang/String;
    ...
    .line 4316
    :sswitch_2
    sget-object v0, Landroid/support/v7/view/menu/p;->i:Ljava/lang/String;
...
.method public final a(Landroid/support/v7/view/menu/p;)V
    ...
    .line 113
    invoke-virtual {p1, p0}, Landroid/support/v7/view/menu/p;->a(Landroid/support/v7/view/menu/ac;)Ljava/lang/CharSequence;
    ...
    .line 115
    invoke-virtual {p1}, Landroid/support/v7/view/menu/p;->d()Z

    move-result v0

    invoke-virtual {p1}, Landroid/support/v7/view/menu/p;->c()C
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 4564
    iget-object v0, v0, Landroid/support/v7/view/menu/p;->b:Landroid/support/v7/view/menu/l;

    .line 5331
    iget-boolean v0, v0, Landroid/support/v7/view/menu/l;->i:Z
    ...
    .line 6262
    sget v3, Landroid/support/v7/a/h;->abc_list_menu_item_icon:I
