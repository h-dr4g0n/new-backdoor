...
.method static a(Landroid/transition/TransitionValues;)Landroid/support/e/am;
    .locals 1
    ...
    .line 86
    invoke-static {p0, v0}, Landroid/support/e/u;->a(Landroid/transition/TransitionValues;Landroid/support/e/am;)V

    goto :goto_0
.end method

.method static a(Landroid/support/e/am;Landroid/transition/TransitionValues;)V
    .locals 2
...
.method static a(Landroid/transition/TransitionValues;Landroid/support/e/am;)V
    .locals 2
    ...
    iput-object v0, p1, Landroid/support/e/am;->b:Landroid/view/View;
...
.method public final a(Landroid/view/ViewGroup;Landroid/support/e/am;Landroid/support/e/am;)Landroid/animation/Animator;
    ...
    .line 170
    invoke-static {p2, v1}, Landroid/support/e/u;->a(Landroid/support/e/am;Landroid/transition/TransitionValues;)V
    ...
    .line 176
    invoke-static {p3, v0}, Landroid/support/e/u;->a(Landroid/support/e/am;Landroid/transition/TransitionValues;)V

    .line 180
    :cond_0
    iget-object v2, p0, Landroid/support/e/u;->a:Landroid/transition/Transition;
...
.method public final a()Landroid/support/e/s;
    ...
    .prologue
    .line 226
    iget-object v0, p0, Landroid/support/e/u;->a:Landroid/transition/Transition;
...
.method public final a(Landroid/support/e/am;)V
    ...
    .line 149
    invoke-static {p1, v0}, Landroid/support/e/u;->a(Landroid/support/e/am;Landroid/transition/TransitionValues;)V

    .line 150
    iget-object v1, p0, Landroid/support/e/u;->a:Landroid/transition/Transition;

    invoke-virtual {v1, v0}, Landroid/transition/Transition;->captureEndValues(Landroid/transition/TransitionValues;)V

    .line 151
    invoke-static {v0, p1}, Landroid/support/e/u;->a(Landroid/transition/TransitionValues;Landroid/support/e/am;)V
...
.method public final a(Landroid/support/e/t;Ljava/lang/Object;)V
    ...
    .prologue
    .line 102
    iput-object p1, p0, Landroid/support/e/u;->b:Landroid/support/e/t;
    ...
    invoke-direct {v0, p1}, Landroid/support/e/v;-><init>(Landroid/support/e/t;)V

    iput-object v0, p0, Landroid/support/e/u;->a:Landroid/transition/Transition;
    ...
    iput-object p2, p0, Landroid/support/e/u;->a:Landroid/transition/Transition;
