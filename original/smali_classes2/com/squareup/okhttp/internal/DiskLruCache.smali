...
.field private static final NULL_SINK:La/t;
...
.field private journalWriter:La/e;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/squareup/okhttp/internal/DiskLruCache;->NULL_SINK:La/t;
...
.method static synthetic access$2500()La/t;
    .locals 1

    .prologue
    .line 88
    sget-object v0, Lcom/squareup/okhttp/internal/DiskLruCache;->NULL_SINK:La/t;
...
.method private declared-synchronized completeEdit(Lcom/squareup/okhttp/internal/DiskLruCache$Editor;Z)V
    ...
    .line 555
    iget-object v0, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:La/e;
    ...
    invoke-virtual {v2, v0}, Lcom/squareup/okhttp/internal/DiskLruCache$Entry;->writeLengths(La/e;)V
...
.method private declared-synchronized edit(Ljava/lang/String;J)Lcom/squareup/okhttp/internal/DiskLruCache$Editor;
    ...
    .line 465
    :cond_2
    iget-object v2, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:La/e;
    ...
    invoke-interface {v2, v3}, La/e;->h(I)La/e;

    move-result-object v2

    invoke-interface {v2, p1}, La/e;->b(Ljava/lang/String;)La/e;
    ...
    invoke-interface {v2}, La/e;->flush()V
...
.method private newJournalWriter()La/e;
    .locals 2
    ...
    invoke-interface {v0, v1}, Lcom/squareup/okhttp/internal/io/FileSystem;->appendingSink(Ljava/io/File;)La/t;
    ...
    invoke-direct {v1, p0, v0}, Lcom/squareup/okhttp/internal/DiskLruCache$2;-><init>(Lcom/squareup/okhttp/internal/DiskLruCache;La/t;)V
...
.method private readJournal()V
    ...
    invoke-interface {v0, v1}, Lcom/squareup/okhttp/internal/io/FileSystem;->source(Ljava/io/File;)La/u;
    ...
    :cond_2
    :try_start_3
    invoke-direct {p0}, Lcom/squareup/okhttp/internal/DiskLruCache;->newJournalWriter()La/e;

    move-result-object v0

    iput-object v0, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:La/e;
    :try_end_3
...
.method private declared-synchronized rebuildJournal()V
    ...
    invoke-interface {v0, v1}, Lcom/squareup/okhttp/internal/io/FileSystem;->sink(Ljava/io/File;)La/t;
    ...
    invoke-interface {v1, v0}, La/e;->b(Ljava/lang/String;)La/e;
    ...
    invoke-interface {v1, v2, v3}, La/e;->j(J)La/e;
    ...
    invoke-interface {v1, v0}, La/e;->h(I)La/e;
    ...
    invoke-interface {v1, v3}, La/e;->b(Ljava/lang/String;)La/e;

    move-result-object v3

    const/16 v4, 0x20

    invoke-interface {v3, v4}, La/e;->h(I)La/e;
    ...
    .line 399
    invoke-virtual {v0, v1}, Lcom/squareup/okhttp/internal/DiskLruCache$Entry;->writeLengths(La/e;)V
...
.method public final declared-synchronized get(Ljava/lang/String;)Lcom/squareup/okhttp/internal/DiskLruCache$Snapshot;
    ...
    .line 434
    iget-object v1, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:La/e;

    const-string v2, "READ"

    invoke-interface {v1, v2}, La/e;->b(Ljava/lang/String;)La/e;

    move-result-object v1

    const/16 v2, 0x20

    invoke-interface {v1, v2}, La/e;->h(I)La/e;

    move-result-object v1

    invoke-interface {v1, p1}, La/e;->b(Ljava/lang/String;)La/e;
