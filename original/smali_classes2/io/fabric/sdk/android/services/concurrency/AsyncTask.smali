...
.field private static final l:Lio/fabric/sdk/android/services/concurrency/b;

.field private static volatile m:Ljava/util/concurrent/Executor;


# instance fields
.field public final d:Lio/fabric/sdk/android/services/concurrency/d;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public volatile f:Lio/fabric/sdk/android/services/concurrency/AsyncTask$Status;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->i:I
    ...
    sput-object v0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->j:Ljava/util/concurrent/ThreadFactory;
    ...
    sput-object v0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->k:Ljava/util/concurrent/BlockingQueue;

    .line 222
    new-instance v1, Ljava/util/concurrent/ThreadPoolExecutor;

    sget v2, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->h:I

    sget v3, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->i:I

    const-wide/16 v4, 0x1

    sget-object v6, Ljava/util/concurrent/TimeUnit;->SECONDS:Ljava/util/concurrent/TimeUnit;

    sget-object v7, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->k:Ljava/util/concurrent/BlockingQueue;

    sget-object v8, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->j:Ljava/util/concurrent/ThreadFactory;
    ...
    sput-object v0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->l:Lio/fabric/sdk/android/services/concurrency/b;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->f:Lio/fabric/sdk/android/services/concurrency/AsyncTask$Status;
    ...
    iput-object v0, p0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->g:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->d:Lio/fabric/sdk/android/services/concurrency/d;

    .line 315
    new-instance v0, Lio/fabric/sdk/android/services/concurrency/AsyncTask$3;

    iget-object v1, p0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->d:Lio/fabric/sdk/android/services/concurrency/d;
    ...
    iput-object v0, p0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->e:Ljava/util/concurrent/FutureTask;
...
.method private b(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 341
    sget-object v0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->l:Lio/fabric/sdk/android/services/concurrency/b;
...
.method static synthetic b(Lio/fabric/sdk/android/services/concurrency/AsyncTask;)V
    ...
    .line 200
    .line 2457
    iget-object v0, p0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->g:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method protected static varargs y_()V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()V"
...
.method public final z_()Z
    ...
    .line 491
    iget-object v0, p0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->e:Ljava/util/concurrent/FutureTask;
