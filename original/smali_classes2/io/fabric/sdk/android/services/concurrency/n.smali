.class public final Lio/fabric/sdk/android/services/concurrency/n;
...
.method private constructor <init>(IILjava/util/concurrent/TimeUnit;Lio/fabric/sdk/android/services/concurrency/f;Ljava/util/concurrent/ThreadFactory;)V
    .locals 9
...
.method public static a()Lio/fabric/sdk/android/services/concurrency/n;
    ...
    .prologue
    .line 81
    sget v1, Lio/fabric/sdk/android/services/concurrency/n;->b:I

    sget v2, Lio/fabric/sdk/android/services/concurrency/n;->c:I
    ...
    new-instance v4, Lio/fabric/sdk/android/services/concurrency/f;

    invoke-direct {v4}, Lio/fabric/sdk/android/services/concurrency/f;-><init>()V

    new-instance v5, Lio/fabric/sdk/android/services/concurrency/o;

    invoke-direct {v5}, Lio/fabric/sdk/android/services/concurrency/o;-><init>()V

    invoke-direct/range {v0 .. v5}, Lio/fabric/sdk/android/services/concurrency/n;-><init>(IILjava/util/concurrent/TimeUnit;Lio/fabric/sdk/android/services/concurrency/f;Ljava/util/concurrent/ThreadFactory;)V
...
.method protected final afterExecute(Ljava/lang/Runnable;Ljava/lang/Throwable;)V
    ...
    .line 110
    invoke-virtual {v0}, Lio/fabric/sdk/android/services/concurrency/f;->a()V
...
.method public final execute(Ljava/lang/Runnable;)V
    ...
    .prologue
    .line 96
    invoke-static {p1}, Lio/fabric/sdk/android/services/concurrency/m;->b(Ljava/lang/Object;)Z
...
.method protected final newTaskFor(Ljava/lang/Runnable;Ljava/lang/Object;)Ljava/util/concurrent/RunnableFuture;
    ...
    invoke-direct {v0, p1, p2}, Lio/fabric/sdk/android/services/concurrency/k;-><init>(Ljava/lang/Runnable;Ljava/lang/Object;)V
...
.method protected final newTaskFor(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/RunnableFuture;
    ...
    invoke-direct {v0, p1}, Lio/fabric/sdk/android/services/concurrency/k;-><init>(Ljava/util/concurrent/Callable;)V
